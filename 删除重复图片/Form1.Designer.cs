namespace 删除重复图片
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btn_start.Location = new System.Drawing.Point(547, 88);
            this.btn_start.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
            this.btn_start.Name = "btn_start";
            this.btn_start.Size = new System.Drawing.Size(149, 37);
            ...
            this.textBox2.Text = "注：拍摄时间 和 文件字节数 相同 而图片内容不一样的几率几乎为 0，如果再严谨点，加上图片的GPS信息或其它信息联合判断。处理完成后，重复的文件会在当前下目录的" +
    "fordel目录中。";
            // 
            // label2
            // 
            ...
            this.Name = "Form1";
            this.Text = "删除重复照片(根据：图片文件的字节数、拍摄时间 判断重复)";
            this.TopMost = true;
